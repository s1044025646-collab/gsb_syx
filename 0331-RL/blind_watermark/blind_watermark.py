...
class WaterMark:
    ...
    def extract(self, filename=None, embed_img=None, wm_shape=None, out_wm_name=None, mode='img', attack=False, attack_ratio=0.1, attack_n=3):
        ...
        if attack:
            embed_img = shelter_att(input_img=embed_img, ratio=attack_ratio, n=attack_n)
